...
<body>
    <ul>
        ...
        <li name="logout" style="float:right">
            <a href="/ecm1417_coursework/res/logout.php" <?php if (isset($_SESSION['loggedin'])){?>style="display: block"<?php }else{?>style="display:none"<?php } ?>>LogOut</a>
            </li>
    </ul>
    <div class="main">
